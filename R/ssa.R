...
## Author: Xiaoxiao Sun
## 01/31/2018
##lambda: log10(nlambda), from ssanova function in the gss package
##theta: log10(theta), from ssanova funciton in the gss package
## The function depends on the gss package
